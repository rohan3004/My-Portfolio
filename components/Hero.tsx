                        ...
                        <div className="ac-header">
                            ...
                            <div className="ac-profile">
                                ...
                                <div className="ac-badges">
                                    {stats.loaded ? (
                                        <>
                                            <div className="ac-pill rank"><i
                                                className="fa-solid fa-chart-line"></i> Top {stats.sub}%
                                            </div>
                                            <div className="ac-pill fire"><i
                                                className="fa-solid fa-fire"></i> {stats.streak} Days
                                            </div>
                                        </>
                                    ) : <div className="sk-anim sk-text"
                        ...
                        <div className="ac-grid">
                            ...
                            <div className="ac-widget">
                                ...
                                <div className="ac-sub">
                                    {weather ? `${weather.city}, ${weather.current?.condition?.text}` :
                                        <div className="sk-anim sk-text"></div>}
                                </div>
                            </div>
                        ...
                        <div className="ac-footer">
                            <div className="ac-stats-wrapper">
                                <div className="ac-stat">
                                    {stats.loaded ? <span>{stats.q}</span> :
                                        <div className="sk-anim sk-text" style={{width: '30px'}}></div>}
                                    Solved
                                </div>
                                <div className="ac-stat">
                                    {stats.loaded ? <span className="text-gold">{stats.stars}★</span> :
                                        <div className="sk-anim sk-text" style={{width: '30px'}}></div>}
                                    CodeChef
                                </div>
                            </div>
                ...
                <div className="section__text">
                    ...
                    <div className="btn-container">
                        <button className="btn specialBtn"
                                onClick={() => window.open('/assets/RohanChakravarty.pdf')}>Resume <i
                            className="fa-solid fa-file"></i></button>
                        <button className="btn specialBtn" onClick={() => location.href = './#contact'}>Contact Me <i
                    ...
                    <div id="socials-container">
                        ...
                        <img src="/assets/linkedin.svg" alt="LinkedIn" className="icon"
                             onClick={() => location.href = 'https://www.linkedin.com/in/rohan-chakravarty-/'}/>
                        <img src="/assets/github.svg" alt="Github" className="icon"
                             onClick={() => location.href = 'https://github.com/rohan3004/'}/>
                    </div>
                </div>
            </section>
        </div>
