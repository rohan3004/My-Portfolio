...
export default function Hero() {
    ...
    const [stats, setStats] = useState<StatsData>({
        q: 0, sub: "0%", streak: 0, stars: 0, badges: 0, activeDays: 0, loaded: false
    });
                    ...
                    <div className="term-body">
                        ...
                        <div className="term-grid">
                            ...
                            <div className="metric-block">
                                ...
                                <span className="mb-value">{stats.loaded ? stats.badges : "..."}</span>
                            ...
                            <div className="metric-block">
                                ...
                                <span className="mb-value">{stats.loaded ? stats.activeDays : "..."}</span>
