...
export default function Photography() {
  ...
  useEffect(() => {
    ...
    const allCaptions = [
        ...
        { caption: "Night Photography - Bulb Mode<br>Shot on Redmi Note 8 Pro", imageUrl: "/assets/photography/p2.jpg" },
  ...
  return (
    <div className="photographyDiv">
      <section id="photography">
        <p className="section__text__p1" style={{ color: "#f2e4ef" }}>Exploring the art of storytelling through visuals</p>
                ...
                <div className="repo-card" key={idx}>
                    <div className="instagram-photo">
                        <div className="instagram-header">
                            <figure>
                                <img src="/assets/insta-pic.webp" alt="Rohan" width="42" height="42" loading="lazy" />
                                <figcaption><h4>rohan.chakravarty</h4></figcaption>
                            </figure>
                        </div>
                        <div className="insta-media"><img src={post.imageUrl} alt={`Photograph ${idx}`} loading="lazy"/></div>
                        <div className="insta-buttons">
                           <div className="left">
                             <i className="fa-regular fa-heart" style={{fontSize: '1.5rem', marginRight:'10px'}}></i>
                             <i className="fa-regular fa-comment" style={{fontSize: '1.5rem', marginRight:'10px'}}></i>
        ...
        <img src="/assets/arrow.svg" alt="Arrow" className="icon arrow" onClick={() => location.href = './#contact'} />
      </section>
    </div>
  );
}