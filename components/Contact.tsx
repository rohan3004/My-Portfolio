    ...
    <div className="contactContainer">
      <section id="contact">
          ...
          <div className="container">
            <div className="screen">
              ...
              <div className="screen-body">
                ...
                <div className={`screen-body-item form-glass ${formState !== 'idle' ? 'has-overlay' : ''}`}>
                  
                  {/* FORM (Always rendered, but blurred/disabled when locked) */}
                  <form id="form" onSubmit={handleSubmit}>
                    <div className="app-form">
                      <div className="app-form-group">
                        <input className="app-form-control" name="name" placeholder="NAME" required disabled={formState === 'locked'} />
                      </div>
                      <div className="app-form-group">
                        <input className="app-form-control" name="email" type="email" placeholder="EMAIL" required disabled={formState === 'locked'} />
                      </div>
                      <div className="app-form-group">
                        <input className="app-form-control" name="contactNo" placeholder="CONTACT NO" required disabled={formState === 'locked'} />
                      </div>
                      <div className="app-form-group message">
                        <input className="app-form-control" name="message" placeholder="MESSAGE" required disabled={formState === 'locked'} />
                      </div>
                      <div className="app-form-group buttons">
                        <button type="button" className="app-form-button" onClick={clearForm} disabled={formState === 'locked'}>
                          RESET
                        </button>
                        <button type="submit" className="app-form-button" disabled={formState === 'locked'}>
                          SEND
                        </button>
                      </div>
                    </div>
                  ...
                  {formState === "sending" && (
                    <div className="form-overlay">
                      ...
                      <p className="status-text" style={{fontSize: '0.9rem', opacity: 0.8}}>Sending...</p>
                    </div>
                  )}
                  ...
                  {formState === "locked" && (
                    <div className="form-overlay">
                       ...
                       <p className="status-text" style={{ fontSize: '1.5rem', marginTop: '5px', color: '#b16f59' }}>{timeLeft}</p>
                    </div>
                  )}
        ...
        <div className="techstack" data-aos="fade-down-left" data-aos-duration="1000" data-aos-delay="200">
          ...
          <div className="ts">
            <img src="/assets/mysql.svg" alt="Mysql Logo" title="Mysql Logo" style={{ width: "70px" }} loading="lazy"/>
      ...
      <footer>
        <div className="footer-links">
          <p>Copyright &copy; <span id="year">{new Date().getFullYear()}</span> Rohan Chakravarty. All Rights Reserved.</p>
